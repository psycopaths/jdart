...
/**
 * Symbolic object "handler" for {@link String}s. The sole purpose of
 * this class is to ensure that {@link String}s are <i>never</i>
 * handled symbolically!
 * 
 *
 */
class StringHandler implements SymbolicObjectHandler {
  ...
  public boolean initialize(ClassInfo ci) {
    return String.class.getName().equals(ci.getName());
  }
