 ...
 * ..., key => ...
 */
public class LOOKUPSWITCH extends gov.nasa.jpf.jvm.bytecode.LOOKUPSWITCH implements SwitchHelper.SwitchInstruction {
  ...
  public int getTargetPC(int targetIdx) {
    return (targetIdx == DEFAULT) ? target : targets[targetIdx];
  }
