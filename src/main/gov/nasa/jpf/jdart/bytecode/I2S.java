...
public class I2S extends gov.nasa.jpf.jvm.bytecode.I2S {
  ...
  public Instruction execute(ThreadInfo ti) {
    ...
    ConcolicUtil.Pair<Short> val = ConcolicUtil.popShort(sf);
    
    ConcolicUtil.pushShort(val, sf);
    
    if (ConcolicInstructionFactory.DEBUG) ConcolicInstructionFactory.logger.finest("Execute I2S: " + val.symb);
    return getNext(ti);
  }
}
