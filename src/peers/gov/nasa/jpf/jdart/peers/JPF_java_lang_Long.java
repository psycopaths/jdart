...
/**
 * JDart version of the native peer class for {@link java.lang.Long}. Refer to
 * {@link JPF_java_lang_Integer} for the rationale behind this redefinition.
 *
 */
public class JPF_java_lang_Long extends gov.nasa.jpf.vm.JPF_java_lang_Long {

  /*
   * (non-Javadoc)
   * @see gov.nasa.jpf.vm.JPF_java_lang_Long#valueOf__J__Ljava_lang_Long_2(gov.nasa.jpf.vm.MJIEnv, int, long)
   */
  @MJI
  @Override
  public int valueOf__J__Ljava_lang_Long_2 (MJIEnv env, int clsRef, long val) {
    ...
    if(attrs == null)
      return super.valueOf__J__Ljava_lang_Long_2(env, clsRef, val);
