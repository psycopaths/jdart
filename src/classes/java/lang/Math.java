...
public final class Math {
  ...
  public static int round(float a) {
    return (int)(a + 0.5f); // FIXME: NaN not handled correctly!
  }
  ...
  public static long round(double a) {
    return (long)(a + 0.5d); // FIXME: NaN not handled correctly!
  }
  ...
  public static float max(float a, float b) {
    return (a >= b) ? a : b; // FIXME: NaN and +/- 0.0 not handled correctly!
  }
  ...
  public double signum(double d) {
    return (d < 0.0) ? -1.0 : (d > 0.0) ? 1.0 : d; // FIXME: NaN not handled correctly
  }
  ...
  public float signum(float f) {
    return (f < 0.0f) ? -1.0f : (f > 0.0f) ? 1.0f : f; // FIXME: NaN not handled correctly
  }
